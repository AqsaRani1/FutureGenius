...
<head>
    ...
    <title>Instructor - FutureGenius</title>
...
<body class="text-gray-900 bg-gray-100 dark:bg-gray-900 dark:text-gray-100">
    <div class="flex h-screen">
        <aside class="flex flex-col w-64 text-white bg-indigo-700" style="height: 100%">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2">
                <a href="{{ route('mycourses') }}"><button data-tab="overview"
                        class="w-full px-3 py-2 text-left rounded hover:bg-indigo-600 tabBtn">My
                        Courses</button></a>
                <a href="#grading"><button data-tab="overview"
                        class="w-full px-3 py-2 text-left rounded hover:bg-indigo-600 tabBtn">Grading</button></a>
            </nav>
        </aside>
        <div class="flex flex-col flex-1" style="height: 100%; overflow-y: auto;">
            <header class="flex items-center justify-between px-6 py-4 bg-white shadow dark:bg-gray-800">
                <h1 class="text-xl font-semibold">Instructor Dashboard</h1>
    ...
    <script type="module">
        import {
            initInstructorUI
        } from '../assets/js/instructor_ui.js';
